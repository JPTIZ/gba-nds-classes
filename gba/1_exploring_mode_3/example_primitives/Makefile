...
#-------------------------------------------------------------------------------
# - TARGET is the name of the output, if this ends with _mb generates a
# multiboot image
...
CXXFLAGS  :=  -g -Wall -O3 -std=c++1y\
              -mcpu=arm7tdmi -mtune=arm7tdmi\
              -fomit-frame-pointer\
              -ffast-math\
              $(ARCH)

CXXFLAGS  +=  $(INCLUDE) -fno-exceptions
...
$(BUILD):
	@[ -d $@ ] || mkdir -p $@
	@echo building from $(CURDIR) to $(BUILD)
